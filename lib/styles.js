...
exports.default = (function (styleOverride, useDarkTheme) {
    ...
    var content = css_1.css({
        width: '100%',
        label: 'content',
    });
    var splitView = css_1.css((_a = {},
        _a["." + content] = {
            width: '50%',
        },
        _a.label = 'split-view',
        _a));
    var diffContainer = css_1.css({
        width: '100%',
    ...
    var codeFoldContent = css_1.css({
        color: variables.codeFoldContentColor,
        label: 'code-fold-content',
    });
    var contentText = css_1.css({
        color: variables.diffViewerColor,
        label: 'content-text',
    });
    var titleBlock = css_1.css((_b = {
        ...
        _b));
    var lineNumber = css_1.css({
        color: variables.gutterColor,
        label: 'line-number',
    });
    var diffRemoved = css_1.css((_c = {
    ...
    var diffAdded = css_1.css((_d = {
        ...
        _d.label = 'diff-added',
        _d));
    var wordDiff = css_1.css({
        padding: 2,
        display: 'inline-flex',
        borderRadius: 1,
        label: 'word-diff',
    });
    var wordAdded = css_1.css({
        background: variables.wordAddedBackground,
        label: 'word-added',
    });
    var wordRemoved = css_1.css({
        background: variables.wordRemovedBackground,
        label: 'word-removed',
    });
    var codeFoldGutter = css_1.css({
        backgroundColor: variables.codeFoldGutterBackground,
        label: 'code-fold-gutter',
    });
    var codeFold = css_1.css({
    ...
    var emptyLine = css_1.css({
        backgroundColor: variables.emptyLineBackground,
        label: 'empty-line',
    });
    var marker = css_1.css((_e = {
            width: 25,
            paddingLeft: 10,
            paddingRight: 10,
            userSelect: 'none',
        ...
        _e));
    var highlightedLine = css_1.css((_f = {
        ...
        _f));
    var highlightedGutter = css_1.css({
        label: 'highlighted-gutter',
    });
    var gutter = css_1.css((_g = {
            userSelect: 'none',
            minWidth: 50,
            padding: '0 10px',
            label: 'gutter',
    ...
    return Object.keys(defaultStyles).reduce(function (acc, key) {
        ...
        return (__assign(__assign({}, acc), (_a = {},
            _a[key] = computerOverrideStyles[key]
                ? css_1.cx(defaultStyles[key], computerOverrideStyles[key])
                : defaultStyles[key],
            _a)));
    }, {});
});
